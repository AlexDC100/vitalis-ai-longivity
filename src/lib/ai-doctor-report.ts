...
<div class="page">
  ...
  <div class="disclaimer">
    <strong>Important:</strong> This report is an educational summary generated by Longevity AI. It is not a medical diagnosis and does not replace consultation with a licensed physician. Always discuss results with a qualified healthcare provider before changing medications, supplements, or treatment plans.
  </div>

  <div class="footer">
    Longevity AI · Doctor · Generated ${escapeHtml(generatedAt)}<br>
